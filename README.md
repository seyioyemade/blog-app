...
- The Blog app is a classic example of a blog website. It will show the list of posts and empower readers to interact with them by adding comments and liking posts.
...
```sh
 ...
 https://github.com/seyioyemade/blog-app.git
  cd blog-app
...
Feel free to check the [Isuues Pages](https://github.com/seyioyemade/blog-app/issues)
